							...
							>
								...
								>
									...
									<div className="absolute bottom-0 left-0 p-6">
										...
										<h3 className="font-outfit text-lg font-bold text-background mt-1">
											{project.title}
										</h3>
										<p className="font-outfit text-xs text-background/60 mt-1">
											{project.location}
										</p>
									</div>
									<div className="absolute top-4 right-4">
										<span
											className={`font-outfit text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded-sm ${
